...
const DailyRoutineSection = () => {
    ...
    return (
        <div ref={containerRef} className="relative h-[450vh] bg-[#F8F8F7] text-neutral-900 font-sans selection:bg-neutral-900 selection:text-white">

            {/* Sticky Viewport */}
            <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden">

                {/* --- PHASE 1: THE DAILY INPUT (LANGSUNG TAMPIL) --- */}
                {/* --- PHASE 1: THE DAILY RITUAL (REWORKED) --- */}
                <motion.div
                    style={phase1}
              ...
              ${i > 24
                ...
                >
                    <div className="relative w-full">
                        ...
                        {/* MAIN CANVAS */}
                        <div className="relative h-[520px] rounded-[3rem] overflow-hidden bg-neutral-950 shadow-2xl">
               ...
               pointer-events-none"
                    ...
                    >
                        <div className="max-w-4xl">
                            ...
                            {/* MAIN STATEMENT */}
                            <h1 className="text-6xl md:text-[9rem] font-bold tracking-tighter
                ...
                <section className="w-full max-w-7xl mx-auto px-6 relative z-20">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 h-[500px]">
                        {ACTIVE_INGREDIENTS.map((item, i) => (
                            <motion.div
                                key={i}
                                // HAPUS onMouseEnter, biarkan logika scroll yang mengatur
                                onClick={() => {
                                    // Opsional: Klik untuk scroll ke bagian tersebut (butuh logika tambahan untuk scrollIntoView)
                                    // Untuk sekarang biarkan klik manual update state visual saja
                                    setActive(i);
                                }}
...
const DisclaimerSection = () => {
    ...
    return (
        <section
            ref={ref}
            className="relative min-h-[110vh] bg-[#020202] flex items-center justify-center px-6"
        >
            {/* Background wordmark */}
        ...
        <section ref={containerRef} className="relative h-screen bg-black flex flex-col justify-center items-center overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-6 mix-blend-screen">
                ...
                <motion.div style={{ y, opacity }}>
                    <h2 className="text-[12vw] md:text-[10rem] font-bold tracking-tighter leading-[0.85] text-white">
                        SMART
                    </h2>
